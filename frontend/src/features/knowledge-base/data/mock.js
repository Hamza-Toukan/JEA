...
export const KB_ARTICLES = [
  {
    ...
    snippet: "يحدد هذا القانون المتطلبات الأساسية للبناء في المملكة الأردنية الهاشمية ويشمل أحكام السلامة العامة، وتصاريح البناء والرقابة على المشاريع الهندسية.",
  },
  {
    id: "KNB-2023-042",
    ...
    snippet: "تتضمن شروط الترقية لمرتبة مستشار أول قضاء مدة لا تقل عن 15 عاماً في ممارسة المهنة، وتقديم بحث هندسي متخصص أو مشروع ريادي معتمد من اللجنة.",
  },
  {
    id: "KNB-2024-018",
    ...
    snippet: "لتجديد التأمين الصحي السنوي، يرجى تسديد اشتراكات النقابة أولاً، ثم تقديم نموذج طلب التجديد مع إرفاق الوثائق المطلوبة ودفع الرسوم المقررة عبر البوابة.",
  },
];
