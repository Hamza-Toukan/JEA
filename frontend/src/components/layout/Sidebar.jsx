...
export function Sidebar() {
  return (
    <aside className="jea-gradient-sidebar flex w-[260px] shrink-0 flex-col border-s border-white/5">
      ...
      <div className="space-y-3 border-t border-white/10 px-4 py-4">
        ...
        <Button
          variant="accent"
          size="md"
          className="w-full justify-center bg-jea-cyan/90 text-white hover:bg-jea-cyan border-jea-cyan/50"
          icon={Headphones}
        >
          تواصل مع الدعم
        </Button>
